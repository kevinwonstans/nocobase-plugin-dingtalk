...
export declare const PluginName = "nocobase-plugin-dingtalk";
/** authType：注册到 NocoBase 认证体系的认证方式标识 */
export declare const AuthName = "dingtalk";
/** 自定义资源名：getAuthUrl / redirectAuth 两个 action 的挂载点 */
export declare const ResourceName = "nocobase-plugin-dingtalk";
/** 用户匹配方式 */
export type UserCheckType = 'orgEmail' | 'personalEmail' | 'mobile';
/** 用户匹配方式选项（v1 / v2 客户端共用，label 为 i18n key） */
export declare const UserCheckTypeOptions: {
    value: UserCheckType;
    labelKey: string;
}[];
